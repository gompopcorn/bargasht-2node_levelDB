...
createChannel(){
    ...
    peer channel create -o 142.132.146.95:7050 -c $CHANNEL_NAME \
...
updateAnchorPeers(){
    setGlobalsForPeer0Org1
    # Replace localhost with your orderer's vm IP address
    peer channel update -o 142.132.146.95:7050 --ordererTLSHostnameOverride orderer0.org1.example.com -c $CHANNEL_NAME -f ../artifacts/channel/${CORE_PEER_LOCALMSPID}anchors.tx --tls $CORE_PEER_TLS_ENABLED --cafile $ORDERER_CA
