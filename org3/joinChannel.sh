...
fetchChannelBlock() {
    ...
    peer channel fetch 0 ./channel-artifacts/$CHANNEL_NAME.block -o 144.76.102.218:9050 \
...
updateAnchorPeers() {
    ...
    # Replace localhost with your orderer's vm IP address
    peer channel update -o 144.76.102.218:9050 --ordererTLSHostnameOverride orderer0.org3.example.com \
