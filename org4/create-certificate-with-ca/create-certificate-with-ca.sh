...
createcertificatesForOrg4() {
  ...
  fabric-ca-client enroll -u https://admin:adminpw@localhost:10054 --caname ca.org4.example.com --tls.certfiles ${PWD}/fabric-ca/org4/tls-cert.pem
  ...
  fabric-ca-client register --caname ca.org4.example.com --id.name orderer0 --id.secret orderer0pw --id.type orderer --tls.certfiles ${PWD}/fabric-ca/org4/tls-cert.pem
  ...
  echo
  fabric-ca-client enroll -u https://peer0:peer0pw@localhost:10054 --caname ca.org4.example.com -M ${PWD}/../crypto-config/peerOrganizations/org4.example.com/peers/peer0.org4.example.com/msp --csr.hosts peer0.org4.example.com --tls.certfiles ${PWD}/fabric-ca/org4/tls-cert.pem
  ...
  echo
  fabric-ca-client enroll -u https://peer0:peer0pw@localhost:10054 --caname ca.org4.example.com -M ${PWD}/../crypto-config/peerOrganizations/org4.example.com/peers/peer0.org4.example.com/tls --enrollment.profile tls --csr.hosts peer0.org4.example.com --csr.hosts localhost --tls.certfiles ${PWD}/fabric-ca/org4/tls-cert.pem
  ...
  echo
  fabric-ca-client enroll -u https://peer1:peer1pw@localhost:10054 --caname ca.org4.example.com -M ${PWD}/../crypto-config/peerOrganizations/org4.example.com/peers/peer1.org4.example.com/msp --csr.hosts peer1.org4.example.com --tls.certfiles ${PWD}/fabric-ca/org4/tls-cert.pem
  ...
  echo
  fabric-ca-client enroll -u https://peer1:peer1pw@localhost:10054 --caname ca.org4.example.com -M ${PWD}/../crypto-config/peerOrganizations/org4.example.com/peers/peer1.org4.example.com/tls --enrollment.profile tls --csr.hosts peer1.org4.example.com --csr.hosts localhost --tls.certfiles ${PWD}/fabric-ca/org4/tls-cert.pem
  ...
  # --------------------------------------------------------------------------------------------------
  # Orderer 0
  mkdir -p ../crypto-config/peerOrganizations/org4.example.com/orderers/orderer0.org4.example.com
  
  echo
  echo "## Generate the orderer0 msp"
  echo

  fabric-ca-client enroll -u https://orderer0:orderer0pw@localhost:10054 --caname ca.org4.example.com -M ${PWD}/../crypto-config/peerOrganizations/org4.example.com/orderers/orderer0.org4.example.com/msp --csr.hosts orderer0.org4.example.com --csr.hosts localhost --tls.certfiles ${PWD}/fabric-ca/org4/tls-cert.pem

  cp ${PWD}/../crypto-config/peerOrganizations/org4.example.com/msp/config.yaml ${PWD}/../crypto-config/peerOrganizations/org4.example.com/orderers/orderer0.org4.example.com/msp/config.yaml

  echo
  echo "## Generate the orderer0-tls certificates"
  echo

  fabric-ca-client enroll -u https://orderer0:orderer0pw@localhost:10054 --caname ca.org4.example.com -M ${PWD}/../crypto-config/peerOrganizations/org4.example.com/orderers/orderer0.org4.example.com/tls --enrollment.profile tls --csr.hosts orderer0.org4.example.com --csr.hosts localhost --tls.certfiles ${PWD}/fabric-ca/org4/tls-cert.pem

  cp ${PWD}/../crypto-config/peerOrganizations/org4.example.com/orderers/orderer0.org4.example.com/tls/tlscacerts/* ${PWD}/../crypto-config/peerOrganizations/org4.example.com/orderers/orderer0.org4.example.com/tls/ca.crt
  cp ${PWD}/../crypto-config/peerOrganizations/org4.example.com/orderers/orderer0.org4.example.com/tls/signcerts/* ${PWD}/../crypto-config/peerOrganizations/org4.example.com/orderers/orderer0.org4.example.com/tls/server.crt
  cp ${PWD}/../crypto-config/peerOrganizations/org4.example.com/orderers/orderer0.org4.example.com/tls/keystore/* ${PWD}/../crypto-config/peerOrganizations/org4.example.com/orderers/orderer0.org4.example.com/tls/server.key
  ...
  echo
  fabric-ca-client enroll -u https://user1:user1pw@localhost:10054 --caname ca.org4.example.com -M ${PWD}/../crypto-config/peerOrganizations/org4.example.com/users/User1@org4.example.com/msp --tls.certfiles ${PWD}/fabric-ca/org4/tls-cert.pem
  ...
  echo
  fabric-ca-client enroll -u https://org4admin:org4adminpw@localhost:10054 --caname ca.org4.example.com -M ${PWD}/../crypto-config/peerOrganizations/org4.example.com/users/Admin@org4.example.com/msp --tls.certfiles ${PWD}/fabric-ca/org4/tls-cert.pem
